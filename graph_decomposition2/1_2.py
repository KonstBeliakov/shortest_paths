...
def dfs_mark_components(adj, vertex):
    global current_component_number, last_component_size  # , component_dict
    component[vertex] = current_component_number
    # component_dict[current_component_number] = component_dict.get(current_component_number, []) + [vertex]
    last_component_size += 1
    for v in adj[vertex]:
